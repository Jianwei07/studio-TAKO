        ...
        <div className="lg:hidden">
          <button
            ...
            className={clsx(
              ...
              invert ? 'hover:bg-isabelline-500' : 'hover:bg-neutral-900/10',
            )}
          ...
          >
            <Icon
              className={clsx(
                'h-6 w-6',
                invert
                  ? 'group-hover:fill-200 fill-white'
                  : 'group-hover:fill-700 fill-neutral-900',
              )}
            />
          </button>
        </div>
  ...
  return (
    <MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
      ...
      <motion.div
        ...
        className="relative flex flex-auto overflow-hidden bg-isabelline-500 pt-14"
      >
        <motion.div
          layout
          className="relative isolate flex w-full flex-col bg-isabelline-500 pt-9"
        >
